...
app
  ...
  .controller('ProductsCtrl', ['$scope', '$state', '$stateParams', '$firebaseArray', '$firebaseObject', '$filter', 'uploadImage', 'user',
    function($scope, $state, $stateParams, $firebaseArray, $firebaseObject, $filter, uploadImage, user) {
  ...
  .controller('NewProductCtrl', ['$scope', 'toastr', '$state', '$filter',
  ...
  .controller('EditProductCtrl', ['$scope', '$firebaseObject', 'toastr', '$state', '$filter',
